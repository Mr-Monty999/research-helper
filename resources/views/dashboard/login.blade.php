                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">{{ trans('dashboard.Welcome Back') }}</h1>
                                    </div>
                                    <form class="user" method="post" action="{{ route('dashboard.login.attempt') }}">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email" name="email" value="{{ old('email') }}"
                                                class="form-control form-control-user" id="exampleInputEmail"
                                                aria-describedby="emailHelp"
                                                placeholder="{{ trans('dashboard.Enter Email Address') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label"
                                                    for="customCheck">{{ trans('dashboard.Remember Me') }}</label>
                                            </div>
                                        </div>
