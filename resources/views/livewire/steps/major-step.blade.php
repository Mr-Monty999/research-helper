<div>
    ...
    <div class="sidebar position-fixed d-flex flex-column">
        ...
        <button class="btn sidebar-btn mb-1 active">التخصص</button>
        ...
        <div class="container d-flex flex-column justify-content-center align-items-center">
            <div style="margin-top:15%;" class="col-5">
                @foreach ($majors as $major)
                    <button wire:click="addToSession('{{ $major->name }}')"
                        class="selection-btn mb-1 select-option @if (session()->get('major') == $major->name) bg-dark @endif">{{ $major->name }}</button>
                @endforeach
                ...
                <div class="container-fluid px-4 px-lg-5">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul style="width: 100%;"
                            ...
                            <li class="nav-item"><button class="btn head-btn" wire:click="next">التالي</button></li>
