<div>
    ...
    <div class="sidebar position-fixed d-flex flex-column">
        ...
        <button class="btn sidebar-btn mb-1 active">نوع المساعدة</button>
    </div>
    <div class="row">
        <div class="container d-flex flex-column justify-content-center align-items-center">
            <div style="margin-top:15%;" class="col-5">
                @foreach ($helpTypes as $helpType)
                    <button wire:click="addToSession('{{ $helpType->name }}')"
                        class="selection-btn mb-1 select-option @if (session()->get('helpType') == $helpType->name) bg-dark @endif">{{ $helpType->name }}</button>
                @endforeach
                ...
                <div class="container-fluid px-4 px-lg-5">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul style="width: 100%;"
                            ...
                            <li class="nav-item"><a class="btn head-btn" target="_blank" href="{{ $link }}">طلب
                                    المساعدة</a></li>
